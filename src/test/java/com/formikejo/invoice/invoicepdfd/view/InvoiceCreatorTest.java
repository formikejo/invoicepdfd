...
public class InvoiceCreatorTest {
    ...
    public void testGlobalVariables() {
        assertThat(view.getId(), is("A00095678"));
        assertThat(view.getPaymentTerms(), is("Payable within 1 calendar month from the invoice date"));
        assertThat(view.getIssueDate(), is("2005-06-21"));
    }
